...
//Controller for Uploading the book and segeragating the pages.
module.exports.uploadBook = async (req, res) => {
  try {
    ...
    res.status(201).json({
      message: "Book uploaded & processed successfully. Book added to library",
      bookId: savedBook._id,
...
//Controller for generating Book Cover
module.exports.generateBookCover = async (req, res) => {
  try {
    const { id } = req.params;
...
//Controller to analyze and generate artStyle, characters and setting
module.exports.analyzeBook = async (req, res) => {
  try {
    const { id } = req.params;
...
//Controller to generate the actual image prompts of all the pages (by book id)
module.exports.generateImagePrompts = async (req, res) => {
  try {
    const { id } = req.params;
    console.log(
...
//Controller to get all the books related to logged in user.
module.exports.fetchLibrary = async (req, res) => {
  try {
